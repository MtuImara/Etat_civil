...
<div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="app-search d-none d-md-block d-lg-block" action="accueil_Admin.php?page=supprimer_Utilisateur" method="POST">
                                            <h3 class="box-title m-b-0">Suppression d'un Utilisateur</h3>
                                                                ...
                                                                <form class="form-horizontal form-material" action="" method="POST">
                                                                    <div class="form-group">
                                                                        <div class="col-md-12 m-b-20">
                                                                            <input type="text" hidden="true" class="form-control" value="<?php echo $data->matricule ?>" name="matricule" > 
                                                                        </div>
...
<?php
    ...
    {
        if (supprimerUser($_POST['matricule']) > 0) 
        {
            echo "bien";
        }
        else echo "non";
